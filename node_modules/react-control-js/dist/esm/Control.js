...
export default function Control(props) {
    ...
    var isInViewPort = useRef(false);
    // default values for styles
    var _f = useState(__assign({}, (opacity && { opacity: 0 }))), styles = _f[0], setStyles = _f[1];
    ...
    return React.createElement("div", { ref: wrapper, className: className, style: __assign(__assign({}, styles), { transition: "all ".concat(duration, "ms ").concat(ease, " ").concat(delay, "ms"), maxWidth: 'max-content' }) }, element);
}
